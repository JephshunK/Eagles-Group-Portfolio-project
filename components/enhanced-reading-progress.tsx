...
export default function EnhancedReadingProgress({ title, estimatedReadTime }: EnhancedReadingProgressProps) {
  ...
  return (
    <>
      ...
      {/* Enhanced progress indicator that appears on scroll */}
      <div
      ...
      {showScrollToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-40 p-2 rounded-full bg-teal-600 text-white shadow-lg hover:bg-teal-700 transition-colors"
